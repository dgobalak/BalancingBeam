...
private:
    ...
    bool read_registers(uint8_t reg, int8_t *data, uint8_t num_bytes);
    bool write_register(uint8_t reg, uint8_t data);
public:
    MPU6050();
    MPU6050(uint8_t device_addr);
    void wakeup();
    bool read_accel_data(int16_t *acc_x, int16_t *acc_y, int16_t *acc_z);
    bool read_gyro_data(int16_t *gyro_x, int16_t *gyro_y, int16_t *gyro_z);
    bool read_temp_data(double *temp);
    bool read_all_data(int16_t *acc_x, int16_t *acc_y, int16_t *acc_z, int16_t *gyro_x, int16_t *gyro_y, int16_t *gyro_z, double *temp);
